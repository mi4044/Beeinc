...
<div class="zzsc-container">
    ...
    <div class="tabs-vertical">
        <ul>
            <li>
                <a class="tab-active" style=""  href="javascript:void(0); ">— 账户</a>
            </li>
            <li>
                <a  href="rechargerecord.html">— 充值记录</a>
            </li>
			<li>
                <a  href="orderrecord.html">— 订单记录</a>
            </li>
            <li>
        ...
        <div class="tabs-content-placeholder">
            ...
            <div class="tab-content-active">
               <span>基本信息</span>
                <p>会员名:<?php echo ($data['username']); ?></p>
                <p>登录账号：<?php echo ($data['username']); ?></p>
                <p>邮箱绑定：<?php echo ($data['email']); ?></p>
                <p>余额：<?php echo ($data['balance']); ?><small><a href="__APP__/recharge/index">充值 ></a></small></p>
                <a href="__APP__/public/logout"><input type="button" value="退出登录" class="yellow_button disabled"></a>
            </div>
        </div>
    </div>
</div>
