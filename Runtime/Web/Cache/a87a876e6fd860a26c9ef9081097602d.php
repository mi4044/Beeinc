...
<head>
    ...
    <style>
        .col-md-4 div{height: 410px;background-color: #FFFFFF}
        .col-md-4 div p{text-align: center;position: relative;top: 30px;font-size: 34px;font-family: 'PingFang Light'}
        .col-md-4 div dd img{position: relative;margin-left: 26%;margin-top: 20%}
        .col-md-4 div dd span a{margin-left: 50px;position:relative;top:70px;left:80px;font-size: 18px;font-family: "PingFang Light";color: #00cac8 }
        .slideBox{margin-top: 0px}
    </style>
</head>
...
<li>
    ...
    <div class="menu">
        <ul>
            <li id="one1"><a href="javascript:void(0);" style="color: #34bbc4">软件列表</a></li>
            <li id="one2"><a href="service.html">服务项目</a></li>
        </ul>
    </div>
    <div class="clear"></div>
    <div style="width: 97%;margin-left: 18%;">
        <div class="row">
            <div class="col-md-4 col-xs-6">
                <div class="slideBox">
                    <div class="bd">
                        <a class="pic"  href="javascript:void(0);"><img src="__ROOT__/Public/Web/Online/img/购买石全石美－定_03.png" alt=""/></a>
                    </div>
                </div>
                <div>
                    <p>石全石美</p>
                    <dd>
                        <span><a href="sexplain.html">购买说明 ></a></span><span><a href="sqsminfo.html">进一步了解 ></a></span><span><a href="javascript:void(0);">购买 ></a></span>
                        <div  class="grid">
                            <div class="effect-milo" style="width: 100%">
                                <a href="https://itunes.apple.com/us/app/shi-quan-shi-mei-zhuan-zhu/id1129689772?l=zh&ls=1&mt=8#" target="_blank">
                                    <img style="width: 150px;left: 70px" src="__ROOT__/Public/Web/Online/img/产品_03.png" alt="img11"/>
                                </a>
                            </div>
                        </div>
            ...
            <div class="col-md-4 col-xs-6">
                <div class="slideBox">
                    <div class="bd">
                        <a class="pic"  href="javascript:void(0);"><img src="__ROOT__/Public/Web/Online/img/购买蜜蜂软件－定_03.png" alt=""/></a>
                    </div>
                </div>
                <div>
                    <p>蜜蜂软件</p>
                    <dd>
                        <span><a href="mexplain.html">购买说明 ></a></span><span><a href="mfrjinfo.html">进一步了解 ></a></span><span><a href="javascript:void(0);">购买 ></a></span>
                        <div  class="grid">
                            <div class="effect-milo" style="width: 100%">
