...
<link href="__ROOT__/Public/Web/contact%20us/css/font/font.css" rel="stylesheet">
    <style>
        .nav_food{float: left;margin-left: 4%;margin-top: 2%}
        .nav_food ul li a{color: #ffffff}
        .nav_food ul li{margin-top: 10px}
    </style>
...
<div style="width: 87%;margin: 0 auto;">
    <ol class="breadcrumb">
        <li><a href="__APP__/Help/videolist">视频教学</a></li>
        <li class="active">观看视频</li>
    </ol>
</div>
<div class="container">
    <h3 style="text-align: center;font-family: 'PingFang Light';font-size: 2em"><?php echo ($video['title']); ?></h3>
    <div id="videobox" style="margin-left: -5%;text-align: center" >
        <video style="width:800px;" controls="controls" autoplay="autoplay"  poster="__ROOT__/Public/Web/video/images/video.png">
            <source src="<?php echo ($video['video']); ?>" type="video/mp4" />
        </video>
    </div>
    <div class="font_p">
        <p style="margin-top: 20px"><a href="__APP__/help/videolist" style="color:#00cac8;">查看全部教学视频 ></a></p>
    </div>
</div>
<!-- footer.html start -->
<footer id="footer">
