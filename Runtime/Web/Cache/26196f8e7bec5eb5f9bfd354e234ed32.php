...
<head>
    ...
    <link rel="stylesheet" href="__ROOT__/Public/Web/contact%20us/css/Explain.css" />
...
<div class="shop_conter">
    <div class="Explain_title">购买石全石美软件激活码说明</div>
    <div class="Explain_conter">
        <p style="text-indent: 2em;">“石全石美”，“蜜蜂软件”是我们针对建材行业营销特点并结合“移动营销”理论研发	产品设计展示软件。您可在App Store和安卓应用市场上面</p>
        <p>搜索，下载免费体验。如果您觉得软件对您有帮助，可向我们购买软件激活码，用于激活软件全数功能，以及我	们对您的全数服务。（备注：由于</p>
        <p>软件激活码属于卡密形式，成功购买之后蜜蜂科技会将软件激活码通过短信发送至您的手机，我们的客服人员会在您收到激活码短信的五分钟之内</p>
        <p>联系您，为您提供专业的后续服务）
        <div class="Explain_footer">
            <div>确认购买的产品</div>
            <img style="float: left;" src="__ROOT__/Public/Web/contact%20us/images/购买蜜蜂软件说明03.png">
            <div>填写基本信息</div>
            <img style="float: left;" src="__ROOT__/Public/Web/contact%20us/images/购买蜜蜂软件说明03.png">
            <div>确认订单信息</div>
        </div>
        <img style="position: relative;right:12%;top: 120px" src="__ROOT__/Public/Web/contact%20us/images/购买蜜蜂软件说明09.png">
        <div class="Explain_footer" style="position: relative;margin-top: 150px">
            <div>将激活码输入到软件个人中心中 即可激活软件</div>
            <img style="float: left;" src="__ROOT__/Public/Web/contact%20us/images/购买蜜蜂软件说明06.png">
            <div>付款成功后，激活码将以短信方式 发送至您的手机</div>
            <img style="float: left;" src="__ROOT__/Public/Web/contact%20us/images/购买蜜蜂软件说明06.png">
            <div>支付</div>
        </div>
        <img style="position: relative;right: 65%;top: 120px" src="__ROOT__/Public/Web/contact%20us/images/购买蜜蜂软件说明09.png">
        <div class="Explain_footer" style="position: relative;margin-top:150px">
            <div>如有疑问请致电028-83530603</div>
        </div>
    </div>
    <div class="messsub">
        <a href="javascript:void(0);"><input type="button"  value="购买石全石美软件激活码" style="color:#fff;" /></a>
    </div>
</div>
<!-- footer.html start -->
<footer id="footer">
