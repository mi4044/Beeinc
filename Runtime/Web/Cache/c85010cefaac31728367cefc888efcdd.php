...
<div class="container-fluid" style="margin-top: 5%">
    <div class="col-md-6" style="margin-top: 8%;height:450px">
            <div class="form">
                <form id="signupForm" method="post" action="__URL__/resetpwd" class="zcform">
                    <p class="clearfix">
                    ...
                    <p class="font_z">密码长度7-16位，密码只能输入数字、字母或字符</p>
                    <p class="clearfix"><input class="submit" type="submit" value="提交"/></p>
                </form>
            </div>
    </div>
    <div class="col-md-6">
