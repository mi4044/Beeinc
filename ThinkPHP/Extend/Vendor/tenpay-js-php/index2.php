...
<div align="center">
  <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="379" align="right" valign="middle" font style="color:#000000;font-size:14px;">您好，请 <A 
  ...
  <table width="760" height="406" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	function payFrm()
	{
		...
		directFrm.submitBT.disabled=true;
		return true;
	}
  </script>
                    ...
                    <td align="center" valign="top" bgcolor="#FFFFEE"><table width="760" height="351" border="0" cellpadding="6" cellspacing="0" class="px14">
                        <tr>
                          ...
                          <td width="269" rowspan="8" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="5">
                            ...
                            <tr>
                              <td height="24"><font style="color:#000000;font-size:14px;"><B>说明1：</B></font></td>
                              </tr>
                            <tr>
                              <td height="24" font style="color:#000000;font-size:14px;">本通道为采用财付通付款。请在支付前与本网站达成一致。</td>
                              </tr>
                            <tr>
                              <td height="24"><font style="color:#000000;font-size:14px;"><B>说明2：</B></font></td>
                              </tr>
                            <tr>
                              <td height="24" font style="color:#000000;font-size:14px;">请务必确认好订单和货款后，再付款。可以在快速付款通道里的“付款概要”和“订单金额”中填入相应的订单信息。</td>
                              </tr>
                        ...
                        <td width="353" valign="top"><?php echo $c_name ?></td>
                        </tr>
                      <tr>
                        <td align="right" valign="top">订单编号：</td>
                        <td valign="top">
			              <input name="order_no" value="<?php echo $mch_vno ?>"  readonly type="text" size="18" maxlength="50" 
                          font style="color:#000000;font-size:14px;"></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top">付款项目：</td>
                        <td valign="top"><span style="color:#000000;font-size:14px;">
                      ...
                      <tr>
                        ...
                        <td valign="top"><textarea name="remarkexplain" cols="48" rows="5" id="remark2"  font style="color:#000000;font-size:14px;"></textarea>
                          <br>
                          请填写您订单的简要说明（30字以内）</td></tr>
                          
                           <tr>
                      	 <td align="right" valign="top">支付方式：</td>
                         <td valign="top" height="36" colspan="2" style="background:#F1F3F2" >
                        	 &nbsp;<img src="images/logo.gif"   />为您提供以下网上支付服务
				     ...
				     <tr>
                         ...
                         <td  valign="top"  colspan="2"  style="background:#FFFFFF;  padding-left:20px ">
                          <input name="bank_type" type="radio" value="0" checked />&nbsp;<img src="images/tenpay.gif" />                 
                          <span style=" color:#868686">（财付通账户余额支付，一点通支付）</span><br /><br />
						<input name="bank_type" type="radio" value="1002" style="vertical-align:top" />&nbsp;<img src="images/10.gif"  />
                        <input name="bank_type" type="radio" value="1001" style="vertical-align:top"  />&nbsp;<img src="images//17.gif" />
                        <input name="bank_type" type="radio" value="1003" style="vertical-align:top"  />&nbsp;<img src="images/2.gif" /> 
                        <input name="bank_type" type="radio" value="1005"  style="vertical-align:top"  />&nbsp;<img src="images/1.gif" />
                        <br /><br />
                        <input name="bank_type" type="radio" value="1004" style="vertical-align:top"  />&nbsp;<img src="images/12.gif" />
						<input name="bank_type" type="radio" value="1008" style="vertical-align:top" />&nbsp;<img src="images/8.gif"  />
                        <input name="bank_type" type="radio" value="1009" style="vertical-align:top"  />&nbsp;<img src="images/27.gif" />
                        <input name="bank_type" type="radio" value="1032" style="vertical-align:top"  />&nbsp;<img src="images/11.gif" />
                        <br /><br />
                        <input name="bank_type" type="radio" value="1022"  style="vertical-align:top"  />&nbsp;<img src="images/3.gif" />
                        <input name="bank_type" type="radio" value="1006" style="vertical-align:top"  />&nbsp;<img src="images/4.gif" />
						<input name="bank_type" type="radio" value="1021" style="vertical-align:top" />&nbsp;<img src="images/7.gif"  />
                        <input name="bank_type" type="radio" value="1027" style="vertical-align:top"  />&nbsp;<img src="images/6.gif" /> 
                        <br /><br />
                        <input name="bank_type" type="radio" value="1010" style="vertical-align:top"  />&nbsp;<img src="images/18.gif" />
                        <input name="bank_type" type="radio" value="1052"  style="vertical-align:top"  />&nbsp;<img src="images/16.gif" />
                        <input name="bank_type" type="radio" value="1020" style="vertical-align:top"  />&nbsp;<img src="images/5.gif" />
