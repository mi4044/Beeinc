...
require_once ("../../eccore/ysymall.php");

require_once ("tenpay_config.php");

$order_no = $_POST['user_id'].date(Ymdhms)."_".$_POST['tenmoney'];
$product_name =$_POST['user_name']."充值".$_POST['tenmoney']."元";
$order_price = $_POST['tenmoney']."元";
$remarkexplain = $_POST['user_name']."充值".$_POST['tenmoney']."元";
$bank_type =0;
