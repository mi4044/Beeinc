$.extend(validatePrompt, {
    ...
    tel:{
        onFocus:"请填写联系人常用的电话，以便于我们联系，如：028-83530603",
        succeed:"",
        isNull:"请输入联系人固定电话",
        error:"电话格式错误，请重新输入"
    },
    ...
    companyaddr:{
        onFocus:"请填写公司地址　如：成都市高新区天府三街福年广场T1",
        succeed:"",
        isNull:"请输入公司地址",
        error:{
...
$.extend(validateFunction, {
    ...
    companyname:function(option) {
        var length = validateRules.betweenLength(option.value.replace(/[^\x00-\xff]/g, "**"), 2, 40);
    ...
    FORM_validate:function() {
        ...
        $("#username1").jdValidate(validatePrompt.username, validateFunction.username, true);
