...
function defineSequence(a, b) {
    ...
    var c = [], d = 0, e = function (e, f) {
        ...
        function p(a, b) {
            var c = a.getBoundingClientRect(), d = !1;
        ...
        var u = {startingStepId: 1, startingStepAnimatesIn: !1, cycle: !0, phaseThreshold: !0, reverseWhenNavigatingBackwards: !1, reverseTimingFunctionWhenNavigatingBackwards: !1, moveActiveStepToTop: !0, animateCanvas: !0, animateCanvasDuration: 250, autoPlay: !1, autoPlayInterval: 5e3, autoPlayDelay: null, autoPlayDirection: 1, autoPlayButton: !0, autoPlayPauseOnHover: !0, navigationSkip: !0, navigationSkipThreshold: 250, fadeStepWhenSkipped: !0, fadeStepTime: 500, ignorePhaseThresholdWhenSkipped: !1, preventReverseSkipping: !1, nextButton: !0, prevButton: !0, pagination: !0, preloader: !1, preloadTheseSteps: [1], preloadTheseImages: [], hideStepsUntilPreloaded: !1, pausePreloader: !1, keyNavigation: !1, numericKeysGoToSteps: !1, keyEvents: {left: function (a) {
            a.prev()
        }, right: function (a) {
            a.next()
        }}, swipeNavigation: !0, swipeEvents: {left: function (a) {
            a.next()
        }, right: function (a) {
            a.prev()
        }, up: void 0, down: void 0}, swipeHammerOptions: {}, hashTags: !1, hashDataAttribute: !1, hashChangesOnFirstStep: !1, fallback: {speed: 500}}, v = 50, w = 100, x = {animation: {WebkitAnimation: "-webkit-", animation: ""}}, y = function (a, b, c) {
            function d(a) {
                r.cssText = a
            }
            ...
            var j, k, l, m = "2.8.3", n = {}, o = b.documentElement, p = "modernizr", q = b.createElement(p), r = q.style, s = ({}.toString, " -webkit- -moz- -o- -ms- ".split(" ")), t = "Webkit Moz O ms", u = t.split(" "), v = t.toLowerCase().split(" "), w = {svg: "http://www.w3.org/2000/svg"}, x = {}, y = [], z = y.slice, A = function (a, c, d, e) {
        ...
        var B = {modernizr: y};
        return B.ui = {defaultElements: {nextButton: "seq-next", prevButton: "seq-prev", autoPlayButton: "seq-autoplay", pagination: "seq-pagination", preloader: "seq-preloader"}, getElements: function (a, b) {
            var c, d, e, f, g, h = [];
            ...
            var a, b, c, d;
            for (a = 0; a < B.noOfSteps; a++)b = B.$steps[a], c = a + 1, d = {seqX: 0, seqY: 0, seqZ: 0}, d.seqX += -1 * b.offsetLeft, d.seqY += -1 * b.offsetTop, B.stepProperties[c].canvasTransform = d
        }, move: function (a, b) {
            ...
            if (B.isFallbackMode !== !0)for (var a = 0; a < B.$steps.length; a++) {
                var b = B.$steps[a];
                if (m(b, "seq-in") === !0) {
                    var c = a + 1;
        ...
        }}, B.animation = {getPhaseProperties: function (a) {
            var b, c, d, e, f = B.$steps[a - 1], g = f.querySelectorAll("*[data-seq]"), h = f.querySelectorAll("*"), j = h.length, k = [], m = [], n = [], o = [], p = [], q = [];
            ...
            var r = Math.max.apply(Math, o), s = Math.max.apply(Math, p), t = Math.max.apply(Math, q), u = Math.max.apply(Math, k), v = Math.max.apply(Math, m), w = Math.max.apply(Math, n);
            return{stepId: a, stepElement: f, children: h, animatedChildren: g, watchedTimings: {maxDuration: u, maxDelay: v, maxTotal: w}, timings: {maxDuration: r, maxDelay: s, maxTotal: t}}
            ...
            var f = 0, g = 0, h = 0;
            return c === !0 || d !== !1 && e !== !1 || (f = a - b, f > 0 ? h = f : 0 > f && (g = Math.abs(f))), {next: h, current: g}
        }, moveActiveStepToTop: function (a, b) {
            if (B.options.moveActiveStepToTop === !0) {
                var c = B.$steps[B.prevStepId - 1], d = B.noOfSteps - 1;
            ...
            if (B.isFallbackMode !== !0) {
                ...
                if (B.ui.show(b, 0), B.options.navigationSkip === !0) {
                    if (B.navigationSkipThresholdActive = !0, 0 !== B.phasesAnimating && (clearTimeout(B.phaseThresholdTimer), clearTimeout(B.nextPhaseStartedTimer), B.options.fadeStepWhenSkipped === !0))for (c = 1; c <= B.noOfSteps; c++)d = B.stepProperties[c], d.isActive === !0 && c !== a && (e = B.$steps[c - 1], f = c, g = {}, g.id = f, g.element = e, B.phasesSkipped.push(g), B.animation.stepSkipped(e));
        ...
        }, reverseProperties: function (a, b, c, d, e) {
            var f, g, h, j, k, m, n, o = this, p = a.children, q = p.length, r = a.timings, s = "", t = "", u = [], v = [];
            for (g = 0; q > g; g++)f = p[g], h = l(i(f, y.prefixed("transitionDuration"))), j = l(i(f, y.prefixed("transitionDelay"))), k = h + j, j = r.maxTotal - k, d !== !0 && (j += b), k = h + j, u.push(k), null !== f.getAttribute("data-seq") && v.push(k), e.reverseTimingFunctionWhenNavigatingBackwards === !0 && (s = i(f, y.prefixed("transitionTimingFunction")), t = o.reverseTimingFunction(s)), f.style[y.prefixed("transition")] = h + "ms " + j + "ms " + t;
            return m = Math.max.apply(Math, u), n = Math.max.apply(Math, v), setTimeout(function () {
                o.domDelay(function () {
                    for (g = 0; q > g; g++)f = p[g], f.style[y.prefixed("transition")] = ""
                })
            }, m + c), n
            ...
            var f, g, h, i, j, k = this, l = 0;
            n(c, "seq-out"), k.domDelay(function () {
                g = k.getPhaseProperties(B.currentStepId, "current"), h = k.getPhaseProperties(a, "next"), l = k.getPhaseThreshold(d, B.options.phaseThreshold, B.isAnimating, g.timings.maxTotal), f = k.getReversePhaseDelay(g.timings.maxTotal, h.timings.maxTotal, B.options.phaseThreshold, B.options.ignorePhaseThresholdWhenSkipped, B.isAnimating), i = k.reverseProperties(g, f.current, 0, d, B.options), j = k.reverseProperties(h, f.next, l, d, B.options), k.startAnimateOut(B.currentStepId, b, -1, i), B.isAnimating = !0, B.firstRun === !1 && k.currentPhaseStarted(B.currentStepId), k.startAnimateIn(a, i, c, l, e, j)
            })
            ...
            var b, c, d, e, f = {linear: "cubic-bezier(0.0,0.0,1.0,1.0)", ease: "cubic-bezier(0.25, 0.1, 0.25, 1.0)", "ease-in": "cubic-bezier(0.42, 0.0, 1.0, 1.0)", "ease-in-out": "cubic-bezier(0.42, 0.0, 0.58, 1.0)", "ease-out": "cubic-bezier(0.0, 0.0, 0.58, 1.0)"};
            ...
            if (B.isFallbackMode !== !0) {
                var b, c, d = B.$steps[a - 1].querySelectorAll("*"), e = d.length;
            ...
            var b = a.transitions, c = !1;
            return b === !1 && (c = !0), c
        }, getPropertySupport: function () {
            var a = !1, b = !1;
            return y.csstransitions === !0 && (a = !0), y.cssanimations === !0 && (b = !0), {transitions: a, animations: b}
        }}, B.animationFallback = {animate: function (a, b, c, d, e, f, g) {
            if (a !== !1) {
                var h = (new Date).getTime(), i = setInterval(function () {
        ...
        }}, B.pagination = {getLinks: function (a) {
            var b, c, d = a.childNodes, e = d.length, f = [];
            for (c = 0; e > c; c++)b = d[c], 1 === b.nodeType && f.push(b);
            return f
        }, update: function () {
            if (void 0 !== B.$pagination.elements) {
                var a, b, c, d, e = B.currentStepId - 1, f = B.$pagination.elements.length;
                if (void 0 !== B.$pagination.currentLinks)for (d = B.$pagination.currentLinks.length, a = 0; d > a; a++)c = B.$pagination.currentLinks[a], o(c, "seq-current");
            ...
            var b = -1, c = B.stepHashTags.indexOf(a);
            return c > -1 && (b = c), b
            ...
            if (B.options.preloader === !0) {
                ...
                if (this.styleElement = document.createElement("style"), this.styleElement.type = "text/css", this.styleElement.styleSheet ? this.styleElement.styleSheet.cssText = this.defaultStyles : this.styleElement.appendChild(document.createTextNode(this.defaultStyles)), a.appendChild(this.styleElement), y.prefixed("animation") === !1 || y.svg === !1) {
                    var b = B.$preloader[0].firstChild, c = function () {
            ...
            if (g(a) === !0) {
                ...
                if (b !== !0)for (d = 0; m > d; d++)for (f = B.$steps[d], h = f.getElementsByTagName("img"), i = h.length, e = 0; i > e; e++)j = h[e], c.push(j); else for (k = [], d = 0; m > d; d++)l = a[d], k[d] = new Image, k[d].src = l, c.push(k[d])
            }
            return c
        }, append: function () {
            ...
            return!1
        }}, B.manageEvents = {list: {load: [], click: [], touchstart: [], mousemove: [], mouseleave: [], hammer: [], keyup: [], hashchange: [], resize: []}, init: function () {
            ...
            var b = B.manageEvents.list[a], c = b.length;
            switch (a) {
                case"hashchange":
            ...
            return addHashChange(a), B.manageEvents.list.hashchange.push({element: window, handler: a}), B.manageEvents.list.hashchange
            ...
            for (k = 0; l > k; k++)e = a[k], h = e.getAttribute("rel"), h === B.$container.id && null === e.getAttribute("data-seq-button") ? (e.setAttribute("data-seq-button", !0), f(e, h)) : null === h && null === e.getAttribute("data-seq-button") && f(e, h), B.manageEvents.list.click.push({element: e, handler: d});
            return B.manageEvents.list.click
        }, stopOnHover: function () {
            var a, b;
            return B.isMouseOver = !1, a = j(B.$container, "touchstart", function () {
                B.isTouched = !0
            }), B.manageEvents.list.touchstart.push({element: B.$container, handler: a}), b = j(B.$container, "mousemove", function (a) {
            ...
            }), B.manageEvents.list.mousemove.push({element: B.$container, handler: b}), b = j(B.$container, "mouseleave", function () {
                B.options.autoPlayPauseOnHover === !0 && B.autoPlay.unpause(), B.isMouseOver = !1
            }), B.manageEvents.list.mouseleave.push({element: B.$container, handler: b}), null
            ...
            }, B.hammerTime = new b(B.$container).on("swipe", c), B.hammerTime.get("swipe").set(B.options.swipeHammerOptions), a = r(B.options.swipeEvents), B.hammerTime.get("swipe").set({direction: a}), B.manageEvents.list.hammer.push({element: B.$container, handler: c}))
            ...
            B.manageEvents.list.keyup.push({element: document, handler: a})
            ...
            }), B.manageEvents.list.resize.push({element: window, handler: c})
        }, pageVisibility: function () {
            var a = j(document, A, function () {
                document[z] ? B.autoPlay.pause() : B.autoPlay.unpause()
            }, !1);
            B.manageEvents.list[A].push({element: document, handler: a})
        }}}, B.init = function (b) {
            var c, d, e, g;
        ...
        }, B.animationStarted = function () {
        }, B.animationEnded = function () {
        }, B.currentPhaseStarted = function () {
        }, B.currentPhaseEnded = function () {
        }, B.nextPhaseStarted = function () {
        }, B.nextPhaseEnded = function () {
        }, B.throttledResize = function () {
        }, B.preloaded = function () {
        }, B.preloadProgress = function () {
        }, B.ready = function () {
        }, B.destroyed = function () {
        }, B.utils = {addClass: n, removeClass: o, addEvent: j, removeEvent: k}, B.init(e), c.push(B), B
    };
    return e
}
if ("function" == typeof define && define.amd)define(["imagesLoaded", "Hammer"], defineSequence); else {
